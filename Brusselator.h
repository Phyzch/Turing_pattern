...
private:
	...
	static double chemical_potential; // chemical potential, defined as ln(Gamma+/Gamma-)
	...
	static double V; // Volume, we scale the total number of species by multiple all of them by V.
public:
	static double length; // length is the size of compartment (0.1) and L is the size of whole cell, L= Brusselator_reaction_system::numsystem*length
	...
	static double beta, gamma, alpha, sigma, sigma1, ep; // reactioin coefficient, same as defined in our note
	static double sigma2, beta1; //  beta1 is reverse reaction coefficient of beta, sigma2 is reverse reaction rate for sigma1. Check our SI for detail
...
private:
	...
	const static int numsystem = 60; // number of Brusselator_reaction entity 
...
public:
	...
	Brusselator_reaction_system(string path, bool load, double timestep, int sequence_number1, double * sampling);
